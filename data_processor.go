...
type DataProcessor interface {
	...
	ProcessData(d data.Data, outputChan chan data.Data, killChan chan error)
	...
	Finish(outputChan chan data.Data, killChan chan error)
}
...
type dataProcessor struct {
	...
	inputChan  chan data.Data
	outputChan chan data.Data
}

type chanBrancher struct {
	branchOutChans []chan data.Data
}
...
func Do(processor DataProcessor) *dataProcessor {
	...
	dp.outputChan = make(chan data.Data)
	dp.inputChan = make(chan data.Data)
